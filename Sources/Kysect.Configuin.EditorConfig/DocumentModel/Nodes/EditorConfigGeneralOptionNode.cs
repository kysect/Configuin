...
public record EditorConfigGeneralOptionNode(
    string Key,
...
{
    public EditorConfigGeneralOptionNode(string key, EqualSymbol equalSymbol, string value) : this(key, equalSymbol, value, [], null)
    {
    }

    public EditorConfigGeneralOptionNode(string key, string value) : this(key, EqualSymbol.Empty, value, [], null)
    {
    }

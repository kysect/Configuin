...
public record DotnetConfigGeneralOptionNode(
    string Key,
...
{
    public DotnetConfigGeneralOptionNode(string key, EqualSymbolSyntaxNode equalSymbol, string value) : this(key, equalSymbol, value, [], null)
    {
    }

    public DotnetConfigGeneralOptionNode(string key, string value) : this(key, EqualSymbolSyntaxNode.Empty, value, [], null)
    {
    }
